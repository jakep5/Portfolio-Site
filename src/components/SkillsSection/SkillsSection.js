            ...
            <div role="presentation" className={styles.skillsWrapper} id="skills">
                <div role="contentinfo" className={styles.skillsHolder}>
                    ...
                    <div className={styles.imageHolder}>
                        <img alt="Skills display" className={styles.img1} src="https://user-images.githubusercontent.com/53489910/71267334-38718980-2342-11ea-83cc-313c0e6e8a25.png" />
                        <img alt="Skills display" className={styles.img2} src="https://user-images.githubusercontent.com/53489910/71267340-3a3b4d00-2342-11ea-99d1-696d108c0cde.png" />
                        <img alt="Skills display" className={styles.img3} src="https://user-images.githubusercontent.com/53489910/71267345-3ad3e380-2342-11ea-925d-79ecab828652.png" />
                    </div>
