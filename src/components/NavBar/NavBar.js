        ...
        return (
            <div className={styles.nav} role="navigation">
                ...
                <div role="navigation" className={styles.navLinks}>
                    ...
                    <a href="https://drive.google.com/file/d/19mebNAlv1bfE5TVVQjwVBYie2zKq74R-/view?usp=sharing" target="_blank" className={styles.resumeLink} id="resumeLink">Resume</a>
                </div>
            </div>
        )
