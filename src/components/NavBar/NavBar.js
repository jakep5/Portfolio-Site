        ...
        return (
            <div className={styles.nav} role="navigation">
                ...
                <div role="navigation" className={styles.navLinks}>
                    ...
                    <a href="https://drive.google.com/file/d/1iJyimsisLNUPTt_oq3V6vMTDxFrouIBl/view?usp=sharing" target="_blank" className={styles.resumeLink} id="resumeLink">Resume</a>
                </div>
            </div>
        )
